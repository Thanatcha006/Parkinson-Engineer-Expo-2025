...
<style>
    ...
    .about-section {
        ...
        box-sizing: border-box; /* ป้องกัน Padding ดันจนล้น */
    }
    ...
    @media (max-width: 991px) {
        .about-header-large { font-size: 2rem; word-wrap: break-word; } /* หัวข้อเล็กลง */
        ...
        /* รูปภาพปรับตามขนาดหน้าจอ ไม่ให้ล้น */
        ...
        .quote-box { font-size: 1.1rem !important; padding: 20px !important; }
    }
    ...
    .about-img-responsive {
        ...
        width: 100%; /* ให้รูปเต็มกรอบของ Grid Cell */
    }
