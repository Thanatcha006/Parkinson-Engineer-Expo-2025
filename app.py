    ...
    if not st.session_state.consent_accepted:
        ...
        with c2:
           with st.container(border=True):
                ...
                # --- แก้ไขตรงนี้: ใช้ HTML เพื่อปรับขนาดตัวหนังสือให้อยู่ในเกณฑ์เดียวกับเนื้อหาอื่นๆ ---
                st.markdown("""
                <div style="font-size: 1.1rem; font-weight: 600; margin-bottom: 10px;">📝 คำแนะนำเพื่อให้ผลลัพธ์แม่นยำขึ้น</div>
                <ul style="font-size: 1rem; margin-bottom: 20px; line-height: 1.6;">
            ...
            if spiral_image is not None and spiral_model is not None:
                try:
                    ...
                    if pred > 0.5:
                        ...
                        # --- แก้ไขสีพื้นหลังการ์ดผลลัพธ์ปกติ ---
                        card_bg = "#86B264" # สีเขียว
                        # ----------------------------------
