...
<style>
    ...
    /* -------------------------------------------------------
       NAVBAR (FIX: กลับมาใช้ Full Width Hack เพื่อไม่ให้หาย)
       ------------------------------------------------------- */
    .navbar {
        ...
        /* เทคนิค Full Width ทะลุขอบ Container */
        width: 100vw;
        ...
        margin-top: -60px; /* ดึงขึ้นไปทับ Header เดิม */
    }
    .nav-links { display: flex; gap: 20px; }
    .nav-links a { font-weight: 600; text-decoration: none; color: #333; transition: 0.3s; }
