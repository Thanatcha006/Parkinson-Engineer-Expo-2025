                    ...
                    if spiral_image is not None: 
                        if spiral_model is not None:
                            try:
                                ...
                                # [UPDATED] แก้ไข Threshold Spiral = 0.3133
                                spiral_threshold = 0.3133
                                
                                if pred > spiral_threshold:
                                    card_bg = "#E4C728"
                                    status_text = "⚠️ พบรูปแบบที่อาจสัมพันธ์กับอาการสั่นแบบโรคพาร์กินสัน"
                                    status_color = "#856404"
                                    confidence = pred * 100
                                    desc_text = f"โมเดลตรวจพบค่าความเสี่ยง {pred:.4f} (เกณฑ์ตัดสิน > {spiral_threshold}) ซึ่งสัมพันธ์กับความผิดปกติของการควบคุมการเคลื่อนไหว"
                                    ...
                                    desc_text = f"โมเดลตรวจพบค่าความเสี่ยง {pred:.4f} (เกณฑ์ตัดสิน > {spiral_threshold}) ซึ่งยังอยู่ในเกณฑ์ปกติ"
                    ...
                    if wave_image is not None:
                        if wave_model is not None:
                            try:
                                ...
                                # [UPDATED] แก้ไข Threshold Wave = 0.2391
                                wave_threshold = 0.2391
    
                                if pred_w > wave_threshold:
                                    card_bg_w = "#E4C728"
                                    status_text_w = "⚠️ พบรูปแบบที่อาจสัมพันธ์กับอาการสั่นแบบโรคพาร์กินสัน"
                                    status_color_w = "#856404"
                                    confidence_w = pred_w * 100
                                    desc_text_w = f"โมเดลตรวจพบค่าความเสี่ยง {pred_w:.4f} (เกณฑ์ตัดสิน > {wave_threshold}) ซึ่งสัมพันธ์กับความผิดปกติของการควบคุมการเคลื่อนไหว"
                                    ...
                                    desc_text_w = f"โมเดลตรวจพบค่าความเสี่ยง {pred_w:.4f} (เกณฑ์ตัดสิน > {wave_threshold}) ซึ่งยังอยู่ในเกณฑ์ปกติ"
