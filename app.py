...
<style>
   ...
   .disclaimer-box {
        ...
        border-radius: 24px;
        padding: 40px 50px;
        box-shadow: 0 20px 60px rgba(0,0,0,0.15); /* เงาลึกมีมิติ */
    ...
    .disclaimer-text {
        ...
        color: #333;
        line-height: 1.8;
        text-align: left; /* เนื้อหาชิดซ้ายให้อ่านง่าย */
    }
    .disclaimer-warning {
...
if not st.session_state.consent_accepted:
    ...
    with c2:
        ...
        <div class="disclaimer-box">
            <div class="disclaimer-header">⚠️ ข้อควรทราบก่อนทำการทดสอบ</div>
            
            <div class="disclaimer-text">
                ระบบนี้เป็นเครื่องมือคัดกรองเบื้องต้นโดยใช้ปัญญาประดิษฐ์ (AI)
                <div style="text-align:center;">
                    <span class="disclaimer-warning">ไม่สามารถใช้แทนการวินิจฉัยของแพทย์ผู้เชี่ยวชาญได้</span>
                </div>
                หากมีอาการผิดปกติหรือความกังวล กรุณาปรึกษาแพทย์เพื่อรับการตรวจเพิ่มเติม
                <hr style="margin: 20px 0; border-color:#eee;">
                <strong>📝 คำแนะนำเพื่อให้ผลลัพธ์แม่นยำขึ้น</strong>
                ...
                อาการมือสั่นอาจเกิดจากหลายสาเหตุ เช่น ความเครียด ภาวะวิตกกังวล หรือโรคอื่นที่ไม่ใช่พาร์กินสัน
        ...
        # Checkbox & Button (อยู่นอก HTML box เพื่อให้ทำงานได้)
        # จัดให้ตรงกลาง
        col_in1, col_in2, col_in3 = st.columns([0.1, 1, 0.1])
        with col_in2:
            accepted = st.checkbox("ข้าพเจ้ารับทราบและยินยอมตามเงื่อนไขข้างต้น")
            st.markdown("<br>", unsafe_allow_html=True)
            
            # ใช้ st.button แต่ครอบด้วย class เพื่อแต่ง CSS
            st.markdown('<div class="hero-btn">', unsafe_allow_html=True) # ใช้คลาสเดียวกับปุ่มบน (หลอก CSS)
    ...
    with c2: 
        ...
        div.stButton.process-btn > button:hover {
            ...
            box-shadow: 0 10px 25px rgba(134, 178, 100, 0.5) !important;
        }
        </style>
        """, unsafe_allow_html=True)
