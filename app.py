...
<style>
    ...
    /* Result Card Styles */
    .result-card {
        /* background-color: กำหนดใน Python แบบ Dynamic */
        color: white;
        border-radius: 20px;
        padding: 30px;
        margin-top: 30px;
