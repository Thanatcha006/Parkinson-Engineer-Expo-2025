...
""").strip()
            ...
            # --- WAVE PROCESSING (Copy of Spiral Logic for Demo) ---
            if wave_image is not None and spiral_model is not None:
                try:
                    # Using spiral_model as placeholder for wave prediction to show the card
