...
<style>
    ...
    /* -------------------------------------------------------
       ABOUT SECTION STYLES (FULL RESPONSIVE)
       ------------------------------------------------------- */
    .about-section {
    ...
    .quote-box {
        ...
        width: 100%;
        grid-column: 1 / -1; /* Quote กินพื้นที่เต็มความกว้าง */
    }
...
<div class="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="?start=true" style="color:#885D95;" target="_self">เริ่มใช้งาน</a>
    </div>
</div>
""", unsafe_allow_html=True)
